...
for i in range(0, classNum + 3):
    ...
    if i in range(3, classNum + 3):
        ...
        pixCount.append(int(listline[1]))
...
listline = templine.split()
while line:
    if listline != [] and listline[0] == 'Histogram' and listline[1] == 'DN':
        if len(band) > 0:
            data.append(band)
        ...
        templine = line.replace("\t", " ")
        listline = templine.split()
        for i in range(0, int(listline[3])):
            band.append(int(listline[2]))
        pass  # next next line
        line = f.readline()
        templine = line.replace("\t", " ")
        listline = templine.split()
        for i in range(0, int(listline[2])):
            band.append(int(listline[1]))
        pass
        line = f.readline()
        templine = line.replace("\t", " ")
        listline = templine.split()
    elif len(listline) > 1 and listline[0] != "Band" and listline[0] != "Basic":
        for i in range(0, int(listline[1])):
            band.append(int(listline[0]))
        line = f.readline()
        templine = line.replace("\t", " ")
        listline = templine.split()
    else:
